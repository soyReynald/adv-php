				...
				<div class="introductionTxt">
						<div id="contenedor" class="taskList">
							<ul class="list-group" id="myUL">
							  <li class="list-group-item"> Gramática <span class="nota" style="float: right;">90</span> </li>
  							  <li class="list-group-item"> Hojas de Cálculo-Investigación <span class="nota" style="float: right;">100</span></li>
							  <li class="list-group-item"> Fórmulas con Excel <span class="nota" style="float: right;">85</span></li>
							  <li class="list-group-item"> UNION y sus usos <span class="nota" style="float: right;">94</span></li>
							</ul>
						</div>
				</div>
		 	</div>
